...
export const apiToolsMultiAddressBalance = (addressList, fallback, explorerEndPoint) => {
  return new Promise((resolve, reject) => {
    fetch(
      explorerEndPoint ? explorerEndPoint + '/insight-api-safecoin/addrs/utxo' : fallback ? 'https://safeexplorer.io/insight-api-safecoin/addrs/utxo' : 'https://www.safeexplorer.ru/insight-api-safecoin/addrs/utxo',
      fetchType(
        JSON.stringify({
          addrs: addressList,
        })
