            ...
            <div className="col-sm-12 no-padding-left">
              <div className="support-box-wrapper">
                <div
                  ...
                  <div className="support-box-link">support.safecoinplatform.com</div>
                </div>
              </div>
              <div className="support-box-wrapper">
                <div
              ...
              <div className="support-box-wrapper">
                <div
                  className="support-box"
                  onClick={ () => this.openExternalWindow('https://safecoinplatform.com/discord') }>
                  <img
                  ...
                  <div className="support-box-link">safecoinplatform.com/discord</div>
                </div>
              </div>
              <div className="support-box-wrapper">
                <div
                  className="support-box"
                  onClick={ () => this.openExternalWindow('https://github.com/SafecoinPlatform/Safewallet') }>
                  <img
                    src="assets/images/support/github-icon.png"
                    alt="Github" />
                  <div className="support-box-title">Github</div>
                  <div className="support-box-link">github.com/SafecoinPlatform/Safewallet</div>
                </div>
              </div>
            </div>
          </div>
